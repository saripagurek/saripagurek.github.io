    ...
    
   {
    ...
    },
    {
      ...
      "content" => %q{
        ...
        <ul>
          <li>A Canvas (or a peice of wood)</li>
          <li>White acrylic paint</li>
          <li>White glue</li>
          <li>White napkins or tissue paper</li>
          <li>Food colouring (assorted colours)</li>
        </ul>
        <p>Paint the wood white (or if it's a canvas just leave it white) and glue the napkins or tissue paper down onto the wood. Make sure it isn't flat. You're going to want it to be bumpy and have different shapes in the paper you glued down. Slowly drip the food colouring all over the napkins. The food colouring shouls spread out a bit if it was dropped onto the napkins (not the wood). </p>
      }
    },
    {
      "date" => "September 2014",
      "content" => "<p>I drew a weird picture of my brother.</p><p><img src='photos/10608518_10204266662340254_2046432245816912504_o.jpg'></p>",
    ...
    },
    {
      ...
      "list" => [
        "Cardboard",
        "Glue (to make the outlines 3D)",
        "Tin foil",
        "Coloured Sharpies"
      ],
      "image" => "photos/GEDC1343-medium.jpg"
    },
    {
      "date" => "October 2014",
    ...
    },
    {
      ...
      "image" => "photos/GEDC1344-medium.jpg"
    },
    {
      "date" => "November 2014",
    ...
    {
      "date" => "January 2015",
      "content" => "<p>This was requested by friends.</p>",
      "title" => "Penguin",
      "category" => "Drawings",
      "image" => "photos/GEDC1396.JPG"
    },
    {
      "date" => "Decmber 2014",
      "content" => "<p>One continuous line that bends, turns, and curves. </p>",
      "title" => "One Line",
      "category" => "Drawings",
      "image" => "photos/GEDC1350-medium.jpg"
    },
    {
      "date" => "August 2014",
      "content" => "<p> </p>",
      "title" => "Couch",
      "category" => "Drawings",
      "image" => "photos/GEDC1354 small.jpg"
    },
    {
      "date" => "December 2014",
      "content" => "<p></p>",
      "title" => "Perky Owl",
      "category" => "Drawings",
      "image" => "photos/GEDC1355.JPG"
    },
    {
      "date" => "Decmber 2014",
      "content" => "<p></p>",
      "title" => "The Tree in the Air",
      "category" => "Drawings",
      "image" => "photos/GEDC1356.JPG"
    },
    {
      "date" => "December 2014",
      "content" => "<p></p>",
    ...
    },
    {
      ...
      "title" => "Portrait #3",
      "category" => "Drawings",
      "image" => "photos/GEDC1365.JPG"
    },
    {
      "date" => "November 2014",
      "content" => "<p>Grey Pastel with a wash of blue water colour</p>",
      "title" => "Race Horse",
      "category" => "Drawings",
      "image" => "photos/GEDC1388.JPG"
    },
    ...
    },
    {
      ...
      "list" => [
        ...
        "Watercolour",
        "Buttons",
        "A roll of masking tape (to sketch the circles)",
        "A black sharpie, a silver marker, and a green metallic marker",
        "White paper (for the eye)"
      ],
      "image" => "photos/GEDC1351-medium.jpg"
    },
    {
      "date" => "2014",
    ...
    {
      "date" => "2014",
      "content" => "<p>I drew this one with a Staples permanent marker, instead of a sharpie (which I usually use). I found that when the ink dried it was dark blue, not black.</p>",
      "title" => "Gellyroll #2",
      "category" => "Art Projects",
      "image" => "photos/GEDC1370.JPG"
    },
    {
      "date" => "2014",
    ...
    },
    {
      ...
      "image" => "photos/GEDC1349-medium.jpg"
    },
    {
      "date" => "November 2014",
