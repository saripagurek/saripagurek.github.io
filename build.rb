...
class Sari < Mustache
  ...
  def LetterCollection
    @content["posts"].select do |post|
      post["category"]=="LetterCollection"
    end
  end
...
["Art Projects", "LetterCollection", "Drawings","index", "Individuals", "Jewelry Sales", "Button Collection"].each do |page|
